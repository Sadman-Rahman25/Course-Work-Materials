...
%token IF ELSE FOR DO INT FLOAT VOID BREAK SWITCH DEFAULT GOTO WHILE CHAR DOUBLE RETURN CASE CONTINUE PRINTLN CONST_INT CONST_FLOAT ADDOP MULOP INCOP RELOP ASSIGNOP LOGICOP NOT LPAREN RPAREN LCURL RCURL LTHIRD RTHIRD COMMA COLON SEMICOLON ID
...
statement :	var_declaration
		{
			outlog<<"At line no: "<<lines<<" statement: var_definition "<<endl<<endl;
			outlog<<$1->getname()+"\n"<<endl<<endl;
...
int main(int argc, char *argv[])
{
	...
	yyin = fopen(argv[1], "r");
	outlog.open("22101008.txt", ios::trunc);
