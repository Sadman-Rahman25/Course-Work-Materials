...
%token IF ELSE FOR DO INT FLOAT VOID SWITCH DEFAULT GOTO WHILE CHAR DOUBLE RETURN CASE CONTINUE PRINTF CONST_INT CONST_FLOAT ADDOP MULOP INCOP RELOP ASSIGNOP LOGICOP NOT LPAREN RPAREN LCURL RCURL LTHIRD RTHIRD COMMA COLON SEMICOLON ID
